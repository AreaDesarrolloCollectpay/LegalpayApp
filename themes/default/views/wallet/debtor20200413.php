...
if (isset($historic) && !$historic) {
    $this->renderPartial('/layouts/partials/side-nav', array('debtor' => $debtor, 'task' => in_array(Yii::app()->user->getState('rol'), Yii::app()->params['advisers']), 'call' => $call, 'historic' => (isset($historic)) ? $historic : false));
}
        ...
        <section class="row p_t_80">
            <section class="padding animated fadeInUp">
                <section class="list_dash">
                    ...
                    <?php
                    if (!$historic) {
                        $width = (in_array(Yii::app()->user->getState('rol'), array_merge(Yii::app()->params['advisers'], Yii::app()->params['coordinators'], Yii::app()->params['admin']))) ? 6 : 12;
                        if (in_array(Yii::app()->user->getState('rol'), array_merge(Yii::app()->params['advisers'], Yii::app()->params['coordinators'], Yii::app()->params['admin']))) {
                            ?>
                            ...
                            <article id="datos_financieros" class="block m_t_20">
                                ...
                                <section class="m_t_10 padding m_b_10"> 
                                    <ul class="tabs tab_cartera"> 
                                        ...
                                        <li class="tab btn-amortization hide-customer"  style="width: 19% !important;"><a href="#debtor_amortization"><i class="fas fa-calculator"></i><?php echo Yii::t('front', 'AMORTIZACIÓN'); ?></a></li>
                                    </ul>
                                    <section class="">
                                        <div class="row">                                             
                                            <!--Tab 0-->
                                                ...
                                                <table class="bordered">                                            
                                                    <thead>
                                                        <tr class="backgroung-table-4">
                                                            ...
                                                            <th width="14%" class="txt_center hide-customer"><?php echo Yii::t('front', 'ASESOR'); ?></th>
                                                            <th width="14%" class="txt_center"><?php echo Yii::t('front', 'METODO'); ?></th>
                                                            <th width="14%" class="txt_center hide-customer"><?php echo Yii::t('front', 'DISCRIMINACIÓN'); ?></th>
                                                ...
                                                <table class="bordered">                                            
                                                    <thead>
                                                        <tr class="backgroung-table-4 <?php echo $debtor->id; ?>">
                                                            ...
                                                            <th width="20%" class="txt_center hide-customer"><?php echo Yii::t('front', 'ASESOR'); ?></th>
