<tr id="itemSpendingWallet-<?= $model->id; ?>">
    ...
    <td class="txt_center icon_table" width="10%">
        ...
        <a href="#new_spending_modal" 
           class="inline padding tooltipped editWalletSpending modal_clic btn-disabled" 
           data-position="top" 
           data-delay="50" 
           data-tooltip="Editar"
           data-idWallet="<?= $model->idDebtor; ?>" 
           data-idSpending="<?= $model->id; ?>" 
