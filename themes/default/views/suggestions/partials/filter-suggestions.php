<div class="dates_all topBarJuridico">
    <ul class="filter_views"> 
        ...
        <li><a href="#new_suggestions_modal" class="tooltipped modal_clic createSuggestions" data-position="bottom" data-delay="50" data-tooltip="<?php echo Yii::t('front', 'Nueva Sugerencia'); ?>"><i class="fa fa-plus lin2"></i> <?php //echo Yii::t('front', 'Nuevo'); ?></a></li>
