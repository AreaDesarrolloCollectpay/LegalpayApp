<section class="cont_home">       
	...
	<div class="dates_all topBarJuridico">
	 <ul class="filter_views">      
		...
		<li><a href="/indicators/tendencies" id="m-tendencies"  class="active"><i class="fa fa-chart-line"></i> Trazabilidad</a></li>
                ...
                <div class="row">  
                    <div class="large-12 medium-12 small-12 columns padding">  
                        <div class="padd_all white border_indicators ">                                
                            <!-- filter -->            
                            <?php
                            $this->renderPartial('/indicators/partials/filter-tendencies', array('active' => 2, 'url' => 'customers', 'regions' => $regions,
                                'ageDebts' => $ageDebts,
                                'coodinators' => $coodinators,
                                'customers' => $customers,));
                            ?>            
                            <!-- END filter -->
                            <div id="canvas-5" class=" " style="width: 100%; min-height: 70vh;"></div> 
                        </div>
                        <!-- class padd_all white border_indicators -->
                    </div>
                </div>
            </section>
        </section>
...
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/assets/js/tendencies.min.js', CClientScript::POS_END);
