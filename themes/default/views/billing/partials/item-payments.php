<tr id="itemPayments-<?= $model->id; ?>">
    <td onClick="document.location.href = '<?php echo Yii::app()->baseUrl; ?>/wallet/debtor/<?php echo $model->idDebtor; ?>';" class="txt_center"><?= Yii::app()->dateFormatter->format('yyyy-MM-dd', $model->datePay); ?></td>
    ...
    <td onClick="document.location.href = '<?php echo Yii::app()->baseUrl; ?>/wallet/debtor/<?php echo $model->idDebtor; ?>';" class="txt_center"><?= $model->location; ?></td>
    ...
    <td onClick="document.location.href = '<?php echo Yii::app()->baseUrl; ?>/wallet/debtor/<?php echo $model->idDebtor; ?>';" class="txt_center"><?= $model->discrimination; ?></td>
    ...
    <!--<td onClick="document.location.href = '<?php echo Yii::app()->baseUrl; ?>/wallet/debtor/<?php echo $model->idDebtor; ?>';" class="txt_center"><?= '0'; ?>%</td>-->
    <td class="txt_center icon_table">                                  
        ...
        <?php if ($model->supportPayments != '') { ?><a href="<?= $model->supportPayments; ?>" class="inline padding tooltipped" data-position="top" data-delay="50" data-tooltip="<?php echo Yii::t('front', 'Descargar'); ?>"><i class="fa fa-download" aria-hidden="true"></i></a><?php } ?>
    </td>
</tr>
