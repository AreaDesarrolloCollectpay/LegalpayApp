    ...
    <section class="conten_inicial">
        <section class="row">
            <section class="padding animated fadeInUp">
                <!--Tabs-->
                <?php
                    $this->renderPartial('/billing/partials/item-tabs',array('active' => 1));
                ?>                  
                        ...
                        <div class="formweb content_filter_advance m_t_10"> 
                            ...
                            <fieldset class="large-12 medium-12 small-12 columns padding m_b_20">
                                <div class="padd_v m_b_10">
                                    <form class="formweb form-filter" data-id="form-filter-payments-" data-url="billing/payments" data-export="billing/exportFilterPayments" enctype="multipart/form-data"> 
                                        ...
                                        <table class="bordered highlight responsive-table">                                            
                                            <thead>
                                                <tr class="backgroung-table-2">
                                                    ...
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'ALIANZA'); ?></th>
                                                    ...
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'DEUDOR'); ?></th>
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'DISCRIMINACIÓN'); ?></th>
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'VALOR PAGO'); ?></th>
                                                    <!--<th width="10%" class="txt_center"><?php echo Yii::t('front', 'HONORARIOS'); ?></th>-->
                                                    <th width="12%" class="txt_center"><?php echo Yii::t('front', 'SOPORTE'); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody id="debtorsPayments">
                                                <?php
                                                foreach ($model as $value) {
                                                    $this->renderPartial('/billing/partials/item-payments', array('model' => $value));
                                                }
                                                ?>
                                            </tbody>
                                        </table> 
...
<?php
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/assets/js/payments.min.js', CClientScript::POS_END);
$js = '';
