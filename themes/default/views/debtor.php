<?php 
$this->renderPartial('/layouts/partials/side-nav', array('task' => in_array(Yii::app()->user->getState('rol'), Yii::app()->params['advisers']),'call' => $call));  
                        ...
                        <article id="datos_financieros" class="block">
                            <form id="frmFinantial-" action="" class="formweb">
                                <fieldset class="large-4 medium-4 small-12 columns padding">
                                        ...
                                        <label><?php echo Yii::t('front', 'Recaudo'); ?></label>
                                        <input type="text" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']->payments))? $othersValues['model']->payments : 0), 0, ',', '.'); ?>"  disabled>
                                        <label><?php echo Yii::t('front', 'Saldo Pendiente'); ?></label>
                                        <input type="text" name="" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']))? ($othersValues['model']->capital + $othersValues['model']->c_interest + $othersValues['model']->fee - $othersValues['model']->payments ) : 0), 0, ',', '.'); ?>" disabled>
                                    </fieldset>
                                    <fieldset class="large-4 medium-4 small-12 columns padding">
                                        <label><?php echo Yii::t('front', 'Intereses'); ?></label>
                                        <input type="text" name="" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']->interest))? $othersValues['model']->c_interest : 0), 0, ',', '.'); ?>" disabled>                                        
                                        <label><?php echo Yii::t('front', 'Estimado'); ?></label>
                                        <input type="text" name="" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']->agreement))? $othersValues['model']->agreement : 0), 0, ',', '.'); ?>" disabled>
                                    </fieldset>
                                    <fieldset class="large-4 medium-4 small-12 columns padding">
                                        <label><?php echo Yii::t('front', 'Honorarios'); ?></label>
                                        <input type="text" name="" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']->fee))? $othersValues['model']->fee : 0), 0, ',', '.'); ?>" disabled>
                                        <label><?php echo Yii::t('front', 'Total'); ?></label>
                                        <input type="text" name="" value="$ <?= Yii::app()->format->formatNumber(((isset($othersValues['model']))? ($othersValues['model']->capital + $othersValues['model']->c_interest + $othersValues['model']->fee) : 0), 0, ',', '.'); ?>" disabled>
                                    </fieldset>
                                <div class="clear"></div>
                            </form>
                            <div class="clear"></div>
