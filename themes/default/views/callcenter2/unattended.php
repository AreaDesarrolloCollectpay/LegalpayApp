                    ...
                    <article id="historia_pagos" class="block">
                        ...
                        <div class="large-6 medium-6 small-12 columns padding m_t_20">
                            <section class="content-scroll-x">
                                <div class="clearfix">                                        
                                <div class="modal-header row p_b_10">
                                    <h1><?php echo Yii::t('front', 'LLAMADAS SIN ATENDER'); ?></h1>
                                </div>
                                    <table class="bordered highlight">                                                                                    
                                        <tbody id="tbody-users_">
                                            <tr id="itemUsers_">
                                                <td class = "txt_center"><?= 'Número de llamadas sin atender'; ?></td>
                                                <td class = "txt_center"><?= '277'; ?></td>
                                            </tr>                                             
                                            <tr id="itemUsers_1">
                                                <td class = "txt_center"><?= 'Promedio de espera antes de desconectar'; ?></td>
                                                <td class = "txt_center"><?= '47 segs'; ?></td>
                                            </tr>                                             
                                            <tr id="itemUsers_2">
                                                <td class = "txt_center"><?= 'Posición promedio en cola al desconectar'; ?></td>
                                                <td class = "txt_center"><?= '2'; ?></td>
                                            </tr>                                             
                                            <tr id="itemUsers_2">
                                                <td class = "txt_center"><?= 'Posición inicial promedio cola'; ?></td>
