...
<section class="cont_home">       
    ...
    <ul class="filter_views">    
		<li><a href="/demo/campaigns" id="m-customers"><i class="feather feather-command"></i> Campañas</a></li>	
        <li>
    </ul>                  
</div> 
                    ...
                    <article id="historia_pagos" class="block">
                        ...
                        <div class="large-6 medium-6 small-12 columns padding m_t_20">
                            <section class="content-scroll-x">
                                <div class="clearfix">                                        
                                <div class="modal-header row p_b_10">
                                    <h1><?php echo Yii::t('front', 'LLAMADAS ATENDIDAS'); ?></h1>
                                </div>
                                    <table class="bordered highlight">                                            
                                        <thead>
                                            <tr class="backgroung-table-4">
                                                <th width="10%" class="txt_center"><?php echo Yii::t('front', 'ATENDIDAS'); ?></th>
                                                <th width="10%" class="txt_center"><?php echo Yii::t('front', 'TRANSFERIDAS'); ?></th>
                                                <th width="10%" class="txt_center"><?php echo Yii::t('front', 'DURACIÓN MEDIA'); ?></th>
                                                <th width="10%" class="txt_center"><?php echo Yii::t('front', 'TOTAL DURACIÓN'); ?></th>
                                                <th width="10%" class="txt_center"><?php echo Yii::t('front', 'ESPERA MEDIA'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody id="tbody-users_">
                                            <tr id="itemUsers_">
                                                ...
                                                <td class = "txt_center"><?= '134.96'; ?></td>
                                                <td class = "txt_center"><?= '2861:06'; ?></td>
                                                <td class = "txt_center"><?= '9.81'; ?></td>
                                            </tr>                                             
                                        </tbody>
                                    </table>                                        
                                </div>
...
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/assets/js/attend.min.js', CClientScript::POS_END);
