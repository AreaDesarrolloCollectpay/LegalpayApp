<section class="cont_home">       
    ...
    <ul class="filter_views">    
		<li><a href="/machine" id="m-customers"><i class="feather feather-cpu"></i> Modelos</a></li>
    </ul>                  
</div>
                        ...
                        <div id="form-predictions"> 
                            <form enctype="multipart/form-data"  class="formweb wrapper_s form-predictions" >
                                ...
                                <select id="predictions-idModel" name="idModel">
                                    <option value=""><?php echo Yii::t('front', 'Modelo predicción'); ?></option>
                                </select>
                                ...
                                <?php }else{ ?>                                
                                <label class=""><?= Yii::t("database", "Elige el proceso judicial para generar la probabilidad de éxito") ?></label>
                            ...
                            <form enctype="multipart/form-data"  class="formweb wrapper_s" >                                
                                ...
                                <div class="centerbtn">
                                    <div class="row txt-prediction" style="display: none;">     
                                        ...
                                        <p class="txt_center"><?php echo Yii::t('front', 'Probabilidad de recaudo de este proceso judicial'); ?></p>
                                    </div>                                    
                                </div>
                            </form>
