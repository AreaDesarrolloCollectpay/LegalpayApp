        ...
        <section class="row">
            <section class="padding animated fadeInUp">
                ...
                <section class="panelBG">
                        <?php 
                            $this->renderPartial('/users/partials/filter-users',array('active' => $active,'type' => 'dependents','id' => $id));
                        ?>
                        <!--Tab 4-->
                                        ...
                                        <table class="bordered highlights">                                            
                                            <thead>
                                                <tr class="backgroung-table-4">
                                                    ...
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'COORDINADOR'); ?></th>
...
Yii::app()->controller->renderPartial('/users/partials/modal-dependents', array(
    'countries' => $countries,
    'advisers' => $advisers,
    'id' => $id
));
