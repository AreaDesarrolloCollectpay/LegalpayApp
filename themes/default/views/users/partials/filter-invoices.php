<div class="dates_all topBarJuridico">
    <ul class="filter_views">
        ...
        <li><a href="#new_invoice_modal" class="tooltipped modal_clic createInvoice" data-idUser="<?php echo (isset($id))? $id : ''; ?>" data-position="bottom" data-delay="50" data-tooltip="<?php echo Yii::t('front', 'Nuevo'); ?>"><i class="fa fa-plus"></i> <?php echo Yii::t('front', ''); ?></a></li>                            
    </ul>                
</div>
