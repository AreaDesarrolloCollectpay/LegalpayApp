<div class="dates_all topBarJuridico">
    <ul class="filter_views">
        ...
        <li ><a href="#new_contracts_modal" class="tooltipped modal_clic createContracts" data-position="bottom" data-delay="50" data-tooltip="<?php echo Yii::t('front', 'Nuevo Documento'); ?>"><i class="fa fa-plus lin2"></i> <?php echo Yii::t('front', ''); ?></a></li>                                                                
    </ul>                  
</div>
    ...
    <fieldset class="large-12 medium-12 small-12 columns padding m_b_20">              
        <form class="formweb form-filter" data-id="form-filter-" data-url="<?php echo (isset($url) && $url != '') ? $url : ''; ?>" data-export="customers/exportContracts" enctype="multipart/form-data"> 
            <fieldset>
                ...
                <select name="TypeDocument" class="cd-select filterType searchDocuments">
