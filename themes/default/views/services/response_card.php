                    ...
                    <table class="bordered highlight responsive-table">
                        <tbody id="listDebtors">
                            ...
                            <tr>
                                ...
                                <td class="txt_center" width="50%"><a href="<?php echo $model->supportPayments; ?>" download target="_blank" class="btnb waves-effect waves-light "><?php echo Yii::t('front', 'Soporte de la Transacción'); ?></a></td>                            
                                <?php } ?>
                            </tr>
                        </tbody>
                    </table>                    
