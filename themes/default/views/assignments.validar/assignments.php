    ...
    <section class="conten_inicial">
        <section class="row">
            ...
            <div class="tittle_head">
                <h2 class="inline"><?= Yii::t("database", "Asignacion de procesos judiciales") ?></h2>
                ...
                <section class="padding animated fadeInUp">
                    <section class="panelBG padd_all m_t_20 m_b_20 adding_db">
                        <form enctype="multipart/form-data"  class="formweb wrapper_s form-assignments" >
                            <p class="hide"><?= Yii::t("database", "Elige el cliente al cual se le va a gestionar el proceso judicial.") ?></p> 
                            ...
                            <?php }else{ ?>                                
                            <label class=""><?= Yii::t("database", "Elige el cliente al cual se le va a gestionar el proceso judicial.") ?></label> 
                    ...
                    <section class="row">
                        <fieldset class="large-6 medium-6 small-6 columns ">
                            <a href="<?php echo Yii::app()->baseUrl.'/assignments/adviser'; ?>" class="btnb waves-effect waves-light left"><?= Yii::t("front", "Asignación Abogado") ?></a>
                        </fieldset>
                    </section>
                    <!--All assignments-->
