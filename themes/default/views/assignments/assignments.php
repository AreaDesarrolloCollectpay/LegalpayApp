    ...
    <section class="conten_inicial">
        <section class="row">
            ...
            <div class="tittle_head">
                <h2 class="inline"><?= Yii::t("database", "Asignación Masiva") ?></h2>
                ...
                <section class="padding animated fadeInUp">
                    <section class="panelBG padd_all m_t_20 m_b_20 adding_db">
                        <form enctype="multipart/form-data"  class="formweb wrapper_s form-assignments" >
                            ...
                            <div class="centerbtn">
                                <button type="submit" class="btnb waves-effect waves-light right"><?php echo Yii::t('front', 'ASIGNAR DEUDORES'); ?></button>
                            </div>
                            <div class="clear"></div>
                        </form>
                    </section>
