    ...
    <section class="conten_inicial">
        <section class="row">
            <section class="padding animated fadeInUp">
                <!--Tabs-->
                <?php
                    $this->renderPartial('/properties/partials/item-tabs',array('active' => 2));
                ?>                  
                <section class="panelBG m_b_20">
                    <section class="">
                        <?php 
//                            $this->renderPartial('/properties/partials/filter-properties',array('type' => 'inmovables'));
                        ?>
                        <div class="row"> 
                            <!--Tab 4-->
                                        ...
                                        <table class="bordered highlight responsive-table">                                            
                                            <thead>
                                                <tr class="backgroung-table-4">
                                                    ...
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'DIRECCIÓN'); ?></th>
                                                    <th width="10%" class="txt_center"><?php echo Yii::t('front', 'MATRÍCULA'); ?></th>
                                                    <th width="20%" class="txt_center"><?php echo Yii::t('front', 'COMENTARIOS'); ?></th>
                                                </tr>
                                                <tr class="filters formweb" data-id="inmovables" data-url="properties/inmovables">
                                                    ...
                                                    <th class="txt_center"><input class="filter-table" id="cluster-filter-address" type="text" name="address" /></th>
                                            ...
                                            <tbody id="tbody-inmovables">
                                                <?php
                                                foreach ($model as $value) {
                                                    $this->renderPartial('/properties/partials/item-inmovables', array('model' => $value));
                                                }
                                                ?>
                                            </tbody>
                                        </table> 
...
<?php
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/assets/js/properties-inmovables.min.js', CClientScript::POS_END);
$js = '';
