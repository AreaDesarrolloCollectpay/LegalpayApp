    ...
    <section class="conten_inicial">
        <section class="row">
            <section class="padding animated fadeInUp">
                <!--Tabs-->
                <?php
                    $this->renderPartial('/properties/partials/item-tabs',array('active' => 3));
                ?>                  
                <section class="panelBG m_b_20">
                    <section class="">
                        <?php 
//                            $this->renderPartial('/properties/partials/filter-properties',array('type' => 'others'));
                        ?>
                        <div class="row"> 
                            <!--Tab 4-->
                                    ...
                                    <div class="clearfix">                                        
                                        <table class="bordered highlight responsive-table">                                            
                                            <thead>
                                                ...
                                                <tr class="filters formweb" data-id="others" data-url="properties/others">
...
<?php
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/assets/js/properties-others.min.js', CClientScript::POS_END);
$js = '';
