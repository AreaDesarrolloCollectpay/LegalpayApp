    ...
    <section class="conten_inicial">
        <section class="row">
            <div class="tittle_head">
                <h2 class="inline"><?= Yii::t("database", "Asignación de procesos judiciales") ?></h2>
                ...
                <section class="padding animated fadeInUp">
                    <section class="panelBG padd_all m_t_20 m_b_20 adding_db">
                        <form enctype="multipart/form-data"  class="formweb form-assignments" >
                            <p class="hide"><?= Yii::t("database", "Elige el cliente.") ?></p> 
                            ...
                            <fieldset class="large-4 medium-4 small-12 columns padding">
                                <label class=""><?= Yii::t("database", "Elige el cliente *") ?></label>                 
                            ...
                            <fieldset class="large-4 medium-4 small-12 columns padding">
				<label><?php echo Yii::t('front', 'Valor Cuantía *'); ?></label>  
                            ...
                            <fieldset class="large-12 medium-12 small-12 columns">
                                <div class="centerbtn">
                                    ...
                                    <div class="large-6 medium-6 small-12 columns padding">
                                        <button id="btn_agregar" type="submit" class="btnb waves-effect waves-light right"><?php echo Yii::t('front', 'ASIGNAR proceso'); ?></button>
                                        <button id="btn_fachada" type="button" class="btnb waves-effect waves-light right"  onclick="alertaBoton()"><?php echo Yii::t('front', 'ASIGNAR proceso'); ?></button>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="clear"></div>
