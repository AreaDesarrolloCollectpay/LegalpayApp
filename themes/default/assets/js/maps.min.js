    ...
    function getMaps(state){
        ...
        locations.map(function (location, i) {
            ...
            var contentString = '<div class="infowindows">'+
                ...
                '<p><span style="'+style+'">Dirección :</span> '+location.address+'</p>'+
                '<span style="font-weight:bold;"><a href="'+SITEURL+'/wallet/debtor/'+location.id+'"> Ver <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></span>'+
            '</div>';
