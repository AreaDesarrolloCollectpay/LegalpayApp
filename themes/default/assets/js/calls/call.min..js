...
var txtWebsocketServerUrl =  "wss://"+txtRealm.value+":8089/ws";
...
function gowebsocket(){
    ...
    conn = new WebSocket( txtWebsocketServerUrl, "sip");
    conn.readyState();
}
...
function loadCredentials() {
    ...
    //window.localStorage.setItem('org.doubango.expert.websocket_server_url', "wss://"+txtRealm.value+":8089/ws");
