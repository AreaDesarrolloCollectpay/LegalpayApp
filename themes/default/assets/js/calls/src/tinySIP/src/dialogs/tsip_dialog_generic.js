...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_generic__message.js',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_generic__publish.js',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_generic__subscribe.js'
    );
}
