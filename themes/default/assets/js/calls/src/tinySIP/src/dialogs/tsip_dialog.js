...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_generic.js',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite.js',
        CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_register.js'
    );
}
