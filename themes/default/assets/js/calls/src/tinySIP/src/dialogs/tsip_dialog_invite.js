...
if(!window.__b_release_mode){
    ...
    CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite__client.js',
    CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite__ect.js',
    CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite__hold.js',
    CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite__server.js',
    CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_invite__timers.js'
    );
}
