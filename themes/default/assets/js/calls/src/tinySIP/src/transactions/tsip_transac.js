...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
     CALLSURL+'/src/tinySIP/src/transactions/tsip_transac_ict.js',
     CALLSURL+'/src/tinySIP/src/transactions/tsip_transac_ist.js',
     CALLSURL+'/src/tinySIP/src/transactions/tsip_transac_layer.js',
     CALLSURL+'/src/tinySIP/src/transactions/tsip_transac_nict.js',
     CALLSURL+'/src/tinySIP/src/transactions/tsip_transac_nist.js'
    );
}
