...
// add tinySAK API
tsip_api_add_js_scripts('head', CALLSURL+'/src/tinySAK/src/tsk_api.js');

// add tinyMEDIA API
tsip_api_add_js_scripts('head', CALLSURL+'/src/tinyMEDIA/src/tmedia_api.js');

// add tinySDP API
tsip_api_add_js_scripts('head', CALLSURL+'/src/tinySDP/src/tsdp_api.js');

// add tinySIP API
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/tsip_action.js',
CALLSURL+'/src/tinySIP/src/tsip_event.js',
CALLSURL+'/src/tinySIP/src/tsip_message.js',
CALLSURL+'/src/tinySIP/src/tsip_session.js',
CALLSURL+'/src/tinySIP/src/tsip_stack.js',
CALLSURL+'/src/tinySIP/src/tsip_timers.js',
CALLSURL+'/src/tinySIP/src/tsip_uri.js'
);
...
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/authentication/tsip_auth.js',
CALLSURL+'/src/tinySIP/src/authentication/tsip_challenge.js'
);

tsip_api_add_js_scripts('head', 
CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog.js',
...
CALLSURL+'/src/tinySIP/src/dialogs/tsip_dialog_layer.js'
...
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/headers/tsip_header.js'
...
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/parsers/tsip_parser_header.js'
...
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/transactions/tsip_transac.js'
// 'src/tinySIP/src/transactions/tsip_transac_ict_.js', #include_in<tsip_transac.js>
...
tsip_api_add_js_scripts('head',
CALLSURL+'/src/tinySIP/src/transports/tsip_transport.js',
CALLSURL+'/src/tinySIP/src/transports/tsip_transport_layer.js'
);