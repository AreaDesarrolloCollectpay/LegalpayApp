...
if(!window.__b_release_mode){
    ...
    CALLSURL+'/src/tinySIP/src/api/tsip_api_common.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_info.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_invite.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_message.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_options.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_publish.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_register.js',
    CALLSURL+'/src/tinySIP/src/api/tsip_api_subscribe.js'
    );
}