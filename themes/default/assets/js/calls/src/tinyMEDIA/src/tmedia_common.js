...
if(!window.__b_release_mode){
    ...
    CALLSURL+'/src/tinyMEDIA/src/tmedia_webrtc4all.js', // must be first
    CALLSURL+'/src/tinyMEDIA/src/tmedia_defaults.js',
    CALLSURL+'/src/tinyMEDIA/src/tmedia_session.js'
    );
}