...
if(!window.__b_release_mode){
    tsdp_api_add_js_scripts('head',
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_A.js',
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_C.js',
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_M.js',
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_O.js',
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        CALLSURL+'/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}