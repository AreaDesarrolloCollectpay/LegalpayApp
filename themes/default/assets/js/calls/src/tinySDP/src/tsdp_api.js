...
// add tinySAK API
tsdp_api_add_js_scripts('head', CALLSURL+'/src/tinySAK/src/tsk_api.js');

tsdp_api_add_js_scripts('head',
    CALLSURL+'/src/tinySDP/src/headers/tsdp_header.js',
    ...
    CALLSURL+'/src/tinySDP/src/tsdp_message.js'
