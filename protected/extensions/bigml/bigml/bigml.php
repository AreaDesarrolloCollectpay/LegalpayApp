...
*/      $this->org = $org;
                                   ...
                                   $retries = 0)
   {
      ...
      if (preg_match('/(fusion|source|dataset|model|evaluation|ensemble|batchprediction|batchcentroid|prediction|cluster|centroid|anomaly|anomalyscore|sample|project|correlation|statisticaltest|association|logisticregression|library|execution|script|topicmodel|deepnet)(\/)([a-z,0-9]{24}|[a-z,0-9]{27})$/i', $resource, $result)) {
         $count = 0;
   ...
   public function get_fusion($modelId, $queryString=null, $shared_username=null,  $shared_api_key=null)
   {
      /*
        Retrieves a model.
        The model parameter should be a string containing the
        ...
        also be provided.
      */
       $rest = $this->get_resource_request($modelId, "fusion", "GET", $queryString);
      //$rest = $this->get_resource_request($modelId, "fusion", "GET", $queryString, true, 3000, 0, $shared_username, $shared_api_key);
      if ($rest == null) return null;
      return $rest->getResponse();
   }
   ...
   public function create_batch_prediction($modelOrEnsembleId, $datasetId, $args=array(), $waitTime=3000, $retries=10) {
      ...
      */
      ...
      if ($resource == null || !in_array($resource['type'],array("model","ensemble", "logisticregression","fusion")) ) {
