...
/**
 * This is the model base class for the table "view_advisers".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ViewAdvisers".
 *
 * Columns in table "view_advisers" available as properties of the model,
 ...
 *
 */
abstract class BaseViewAdvisers extends GxActiveRecord {
	...
	public function tableName() {
		return 'view_advisers';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'ViewAdvisers|ViewAdvisers', $n);
	}
