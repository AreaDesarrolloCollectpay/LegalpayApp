...
/**
 * This is the model base class for the table "tbl_customers_info".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CustomersInfo".
 *
 * Columns in table "tbl_customers_info" available as properties of the model,
 * followed by relations of table "tbl_customers_info" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseCustomersInfo extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_customers_info';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'CustomersInfo|CustomersInfos', $n);
	}
