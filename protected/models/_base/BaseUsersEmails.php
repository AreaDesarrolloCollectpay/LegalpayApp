...
/**
 * This is the model base class for the table "tbl_users_emails".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "UsersEmails".
 *
 * Columns in table "tbl_users_emails" available as properties of the model,
 * followed by relations of table "tbl_users_emails" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseUsersEmails extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_users_emails';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'UsersEmails|UsersEmails', $n);
	}
	...
	public function rules() {
		return array(
			array('idUserEmail, idUser, idTypeReference, name, email, active', 'required'),
			array('idUserEmail, idUser, idTypeReference, active', 'numerical', 'integerOnly'=>true),
			array('name, email', 'length', 'max'=>500),
                        array('email', 'email'),
                        array('comment', 'safe'),
			array('idUserEmail, idUser, idTypeReference, active', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, idUserEmail, idUser, idTypeReference, name, email, comment, active, dateCreated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('app', 'ID'),
			'idUserEmail' => Yii::t('front', 'Usuario Creador'),
