...
class DebtypeController extends GxController {
	...
	public function actionCreate() {
		$model = new Debtype;
		if (isset($_POST['Debtype'])) {
			$model->setAttributes($_POST['Debtype']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Debtype');
		if (isset($_POST['Debtype'])) {
			$model->setAttributes($_POST['Debtype']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Debtype')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new Debtype('search');
		$model->unsetAttributes();
		if (isset($_GET['Debtype'])){
			$model->setAttributes($_GET['Debtype']);
                }
