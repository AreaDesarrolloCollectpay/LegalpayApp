                            ...
                            <tr><td width="463" height="724" valign='top'>             <div class="post-content">
                                        <form name="formcuadro">
                                            ...
                                            <table width="450" border='0' align="center">
                                                <tr bgcolor="#FFFFFF">
                                                    <td width="174"><div align="right" class="Estilo1 Estilo3">Dinero a solicitar:</div></td><td width="266"> <input name="capital" type="text" value="100" size="6" maxlength="5"></td>
                                                ...
                                                <tr bgcolor="#FFFFFF">
                                                    ...
                                                    <td><span class="Estilo3">
                                                            <input name="int1"  type="text" value="6" size="2" maxlength="1" />
                                                            % 
